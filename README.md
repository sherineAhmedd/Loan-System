...
**How to submit**
Follow the challenge submission instructions. Example email:

Subject: Full Stack Engineer Challenge - [Your Name]

Body:
1. Full name: [Your Name]
2. GitHub repo: https://github.com/<your-username>/Loan-System
3. Time taken: X hours
4. What I’m most proud of: [2-3 sentences]
5. Extension requests: [if any]

Attach or link test coverage reports and `SOLUTION.md`.

**Contact / Support**
If anything breaks while following these steps, open an issue in the repo or email me at the address used for submission.

---
Generated for the Flend take-home challenge.
